...
Welcome to `broom-sm` contributor's guide.
...
If you experience bugs or general issues with `broom-sm`, please have a look
...
You can help improve `broom-sm` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`broom-sm` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `broom-sm`'s files. While this mechanism can
...
```
conda create -n broom-sm python=3 six virtualenv pytest pytest-cov
conda activate broom-sm
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/broom-sm.git
   cd broom-sm
   ```
...
5. Install [pre-commit]:
   ...
   `broom-sm` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/broom-sm
[issue tracker]: https://github.com/<USERNAME>/broom-sm/issues
